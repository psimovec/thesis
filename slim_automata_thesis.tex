...
\end{table}
	...
	\begin{table}[ht]
		...
		\caption{Table shows that ltl2ldba has unique best results most often, but Seminator slim has some best hits too.}
	...
	\begin{table}[ht]
		...
		\caption{Table without Examples shows that ltl2ldba still has the best results most often, but Seminator slim has some best hits too. And ePMC has lots of second best... }
