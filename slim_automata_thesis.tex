...
\thesissetup{
	...
	thanks      = {%
		...
		My gratitude extends to thank Ernst Moritz Hahn for his advice, providing us ePMC tool, and adding a requested feature that allowed me to compare the tools. I would also like to thank Mateo Perez for providing us Mungojerrie tool before its release and willingness to answer any questions about it.
