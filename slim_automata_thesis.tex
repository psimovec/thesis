...
\begin{document}
	...
	\chapter{Preliminaries}
		In this chaaapter we define a Büchi automaton and its generalized version.
...
autoreconf -i && ./configure && make.
	...
	\begin{center}
		\begin{tabular}{ |c|c|c|c| } 
			...
			&weak&strong&best \\
			\hline
			via tba&cell1 & cell2 & cell3 \\
			\hline
			via tgba&cell4 & cell5 & cell6 \\ 
			\hline
			best&cell7 & cell8 & cell9 \\ 
			\hline
		\end{tabular}
	\end{center}
