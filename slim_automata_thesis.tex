...
autoreconf -i && ./configure && make.
	...
	\chapter{Evaluation}
	Evaluation part builds on seminator-evaluation. We compare amount of states of output automata. We compare the data on 2 dataset. First dataset are 100 literature formulas, second dataset is 500 automata that were randomly generated.
	
	3x3 tabulka, 3 sloupec best of, pocty minimalnich automatu 2x2 tabulka.. 
	celkovy cas v tabulce 3x3
	\section{Overview of Compared Tools}
	\begin{center}
		\begin{tabular}{ |c|c|c| } 
			\hline
			tool&automaton size&running time (s)\\
			\hline
			ltl2tgba&3086&37\\
			\hline
			optimized seminator default&3751&67\\
			\hline
			no.seminator default&4748&57\\
			\hline
			optimized seminator strongslim viatba &6840&399\\
			\hline
			optimized seminator strongslim viatgba 	&7698&571\\
			\hline
			optimized seminator weakslim viatba &	8101&405\\
			\hline
			optimized seminator weakslim viatgba&	9045&632\\
			\hline
			optimized seminator viatba &6657&804\\
			\hline
			optimized seminator viatgba 	&7445&1203\\
			\hline
			optimized seminator weakslim &	7959&1037\\
			\hline
			optimized seminator strongslim&	6721&1070\\
			\hline
			optimized seminator slim&	6526&2107\\
			\hline
			optimized epmc slim acc &9943&5298\\
			\hline
			yes.epmc slim best&9081&20798\\
			\hline
		\end{tabular}
	\end{center}
	...
	\begin{center}
		\begin{tabular}{ |c|c|c|c|c|c|c| } 
			...
			\hline
			via tba&617&219& 436 &185& 431&404\\
			\hline
			via tgba&654&210& 474&174& 468&384\\ 
			\hline
			best&617&429& 436&359& 431&788 \\ 
			\hline
		\end{tabular}
	\end{center}
	...
	\begin{center}
		\begin{tabular}{ |c|c|c|c|c|c|c| } 
			...
			\hline
			via tba&8101&405& 6840 &399& 6657&804\\
			\hline
			via tgba&9045&632& 7698&571& 7445&384\\ 
			\hline
			best&7959&1037& 6721&1070& 6526&2107 \\ 
			\hline
		\end{tabular}
	\end{center}
	...
	Transforming input automata to tba first creates results which are close to best ones. 
		...
		\begin{center}
			\begin{tabular}{ |c|c|c| } 
				\hline
				&unique minimal hits&minimal hits\\
				\hline
				weak&68 & 202\\
				\hline
				strong&296 & 430\\ 
