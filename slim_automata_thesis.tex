...
\thesissetup{
	...
	abstract    = {%
		The thesis describes \emph{nondeterministic slim Büchi good for Markov decision processes automata} construction and extends it for \emph{generalized Büchi Automata}. The construction is implemented in a tool called \emph{Seminator}. Slim automata constructed by Seminator are compared to other automata produced by different tools. The automata are compared by the number of states, construction time, and learning speed when used for reinforcement learning in the \emph{Mungojerrie} tool.
	},
	thanks      = {%
		I am extremely grateful to my supervisors František Blahoudek and Jan Strejček, for their consultations, invaluable advice, and support. Thank you for the opportunity to work on an exciting topic.
		
		My gratitude extends to Ernst Moritz Hahn for his advice, providing us ePMC tool, and adding a requested feature that allowed me to compare the tools. I would also like to thank Mateo Perez for providing us Mungojerrie tool before its release and willingness to answer any questions about it.
		
		I want to thank my aunt for her encouragement and support during my studies. Lastly, I would like to express my gratitude to the rest of my family and friends for their support.
	},
	bib         = {exampl.bib},
...
\begin{document}
	...
	\chapter{Slim Automata Construction}
			...
			In this section we define transition function for \emph{strong slim} ($\gamma_{p}$)\cite{hlavni} and \emph{weak slim} ($\gamma_{w}$)\cite{priv} automata,
...
$./seminator --slim --strong --via-tgba --postprocess=0 -f automaton.hoa
	...
	Then the tool ltlcross cross-compares the automaton with \texttt{seminator -{}-slim} with all supported additional parameters.
...
\begin{table}[ht]
	...
	\caption{Slim automata on both datasets without any post-processing (no timeouts).}
		\begin{tabular}{ |c||c|c|c|c| } 
			...
			via tba	&	1095	&2	& 1112 	&2\\
			\hline
			via tgba&	1122	&2		&1147	&2\\ 
			\hline
			\hline
			\hline
			seminator&\multicolumn{2}{c|}{weak}&\multicolumn{2}{c|}{strong} \\
			...
			\hline
			via tba&17567&	33& 18764 &33\\
			\hline
			via tgba&19320&	32& 20789&33\\ 
			\hline
		\end{tabular}
\end{table}
	\clearpage
	...
	\begin{table}[ht]
		...
		\begin{tabular}{ |c||c|c|c|c|c|c| } 
			...
			via tba&617&29& 431 &58& 431&44\\
			\hline
			via tgba&654&27& 476&52& 468&45\\ 
			\hline
			best&617&34& 436&78& 431&100 \\ 
			\hline
			...
			\hhline{|=======|}
			via tba&9160&324& 7725 &329& 7456&379\\
			\hline
			via tgba&10317&559& 8793&503& 8434&577\\ 
			\hline
			best&8958&589& 7578&538& 7275&665 \\ 
			\hline
		\end{tabular}
	\end{table}
	...
	Transforming input automata to tba first creates results that are close to the best ones. There were no timeouts in the literature dataset. In the random dateset, there were 2-4 timeouts for each tool.
...
\end{table}
	...
	\clearpage
		...
		\begin{figure}[ht]
			...
			\begin{tikzpicture}
				\input{scatter/slim-ltl3tela.tikz}
			\end{tikzpicture}
		\end{figure}
	...
	I have ended up evaluating the performance of Seminator's slim automata on the recently released Mungojerrie tool and comparing it against its supported tools ltl2ldba and ePMC. Results of Mungojerrie's benchmarks look promising for Seminator's slim automata. However, I can't draw any definitive conclusions here, as the number of Mungojerrie's benchmarks is not that high.
