...
\begin{document}
	...
	\chapter{Preliminaries}
		...
		\section{Büchi Automaton}
			...
			Finally, we define the \emph{language} $L_A \subseteq \Sigma^\omega$ recognized by the automaton $\cA$. An $\omega$-word $w \in \Sigma^\omega$ belongs to $L_A$ iff there exists an accepting run of $\cA$ over the word $w$. 
