			...
			\begin{figure}[ht]
				\begin{center}
					\begin{tikzpicture}[automaton]
						...
						\node[state,above = 5cm of bp-ad-a-0, cd orange] (bp-ad-d-1) {$\{A,D\}, \{D\},1$};
						...
						(bp-ad-a-0) edge[ blue, pos=0.3]  pic[] {eacc=3} pic{l=$a$} (bp-a-1)
						(bp-d-1) edge[orange, pos=0.38]  pic[] {eacc=3} pic{l=$d$} (bp-d-0)
						(bp-ad-1) edge[orange, pos=0.36]  pic[] {eacc=3} pic{l=$d$} (bp-d-0)
						(bp-ad-d-1) edge[orange, pos=0.72]  pic[] {eacc=3} pic{l=$d$} (bp-d-0)
						...
						(bp-ad-a-0) edge[ blue, pos=0.8] pic[] {eacc=3} pic{l=$c$} (bp-d-1)
