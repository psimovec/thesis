...
\begin{document}
	...
	\paragraph{ltlcross}...
		...
		For example \texttt{seminator -{}-slim -{}-strong -{}-optimalizations=0 -{}-via-tgba} generates output according to algorithm in 2.5. (Using \texttt{-{}-via-tba} converts input to tba first) With automaton
...
$ cat automaton.hoa | ./seminator --slim
	...
	I have implemented generalized slim construction and options for it mentioned in previous section 3.2. I have also added an option to create breakpoint automata.
	...
	(jeste nevim kde tuto sekci dat, jestli ma mit tento nazev, co vsechno tady bude treba dat... )
